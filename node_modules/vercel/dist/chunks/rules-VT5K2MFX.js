...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-WPJAKB5Y.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-WPJAKB5Y.js")).default(client, args);
    case "add":
      return (await import("./add-6TZOFI3R.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-KYT5ICO4.js")).default(client, args);
    case "rm":
      return (await import("./rm-SJ26XXVR.js")).default(client, args);
    case "update":
      return (await import("./update-JDLTS73Z.js")).default(client, args);
    default:
