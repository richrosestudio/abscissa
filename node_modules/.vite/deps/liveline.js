...
function spawnOnSwing(state, momentum, dotX, dotY, swingMagnitude, accentColor, dt, options) {
  ...
  if (momentum === "down" && (options == null ? void 0 : options.downMomentum) !== true) return 0;
  ...
  if (candleAlpha > 0.01) {
    ...
    if (opts.morphT >= 0 && revealOld.length > 0) {
      ...
      drawCandlesticks(
        ...
        ((_a = opts.liveCandle) == null ? void 0 : _a.time) ?? -1,
        opts.now_ms,
        opts.hoverX ?? 0,
        opts.scrubAmount,
        opts.liveBirthAlpha,
      ...
      drawCandlesticks(
        ...
        revealCandles,
        opts.displayCandleWidth,
        ((_b = opts.liveCandle) == null ? void 0 : _b.time) ?? -1,
        opts.now_ms,
        opts.hoverX ?? 0,
        opts.scrubAmount,
        opts.liveBirthAlpha,
...
function updateWindowTransition(cfg, wt, displayWindow, displayMin, displayMax, noMotion, now_ms, now, points, smoothValue, buffer) {
  ...
  if (wt.to !== cfg.windowSecs) {
    ...
    if (targetVisible.length > 0) {
      const targetRange = computeRange(targetVisible, smoothValue, (_a = cfg.referenceLine) == null ? void 0 : _a.value, cfg.exaggerate);
...
function updateHoverState(hoverPixelX, pad, w, layout, now, visible, scrubAmount, lastHover, cfg, noMotion, leftEdge, rightEdge, chartW, dt) {
  ...
  if (hoverPixelX !== null && hoverPixelX >= pad.left && hoverPixelX <= w - pad.right) {
    ...
    if (v !== null) {
      ...
      (_a = cfg.onHover) == null ? void 0 : _a.call(cfg, { time: t, value: v, x: clampedX, y: layout.toY(v) });
    }
  }
...
function useLivelineEngine(canvasRef, containerRef, config) {
  ...
  const displayValueRef = (0, import_react2.useRef)(config.value);
  const displayValuesRef = (0, import_react2.useRef)(/* @__PURE__ */ new Map());
  const seriesAlphaRef = (0, import_react2.useRef)(/* @__PURE__ */ new Map());
  const displayMinRef = (0, import_react2.useRef)(0);
  const displayMaxRef = (0, import_react2.useRef)(0);
  const targetMinRef = (0, import_react2.useRef)(0);
  const targetMaxRef = (0, import_react2.useRef)(0);
  const rangeInitedRef = (0, import_react2.useRef)(false);
  const displayWindowRef = (0, import_react2.useRef)(config.windowSecs);
  const windowTransitionRef = (0, import_react2.useRef)({
  ...
  const arrowStateRef = (0, import_react2.useRef)({ up: 0, down: 0 });
  const gridStateRef = (0, import_react2.useRef)({ interval: 0, labels: /* @__PURE__ */ new Map() });
  const timeAxisStateRef = (0, import_react2.useRef)({ labels: /* @__PURE__ */ new Map() });
  const orderbookStateRef = (0, import_react2.useRef)(createOrderbookState());
  const particleStateRef = (0, import_react2.useRef)(createParticleState());
  const shakeStateRef = (0, import_react2.useRef)(createShakeState());
  const badgeColorRef = (0, import_react2.useRef)({ green: 1 });
  const badgeYRef = (0, import_react2.useRef)(null);
  const reducedMotionRef = (0, import_react2.useRef)(false);
  const sizeRef = (0, import_react2.useRef)({ w: 0, h: 0 });
  const ctxRef = (0, import_react2.useRef)(null);
  const rafRef = (0, import_react2.useRef)(0);
  const lastFrameRef = (0, import_react2.useRef)(0);
  const badgeRef = (0, import_react2.useRef)(null);
  const hoverXRef = (0, import_react2.useRef)(null);
  const scrubAmountRef = (0, import_react2.useRef)(0);
  const lastHoverRef = (0, import_react2.useRef)(null);
  const lastHoverEntriesRef = (0, import_react2.useRef)([]);
  const chartRevealRef = (0, import_react2.useRef)(0);
  const pauseProgressRef = (0, import_react2.useRef)(0);
  const timeDebtRef = (0, import_react2.useRef)(0);
  const lastDataRef = (0, import_react2.useRef)([]);
  const lastMultiSeriesRef = (0, import_react2.useRef)([]);
  const frozenNowRef = (0, import_react2.useRef)(0);
  const pausedDataRef = (0, import_react2.useRef)(null);
  const pausedMultiDataRef = (0, import_react2.useRef)(null);
  const loadingAlphaRef = (0, import_react2.useRef)(config.loading ? 1 : 0);
  const displayCandleRef = (0, import_react2.useRef)(null);
  const liveBirthAlphaRef = (0, import_react2.useRef)(1);
  const liveBullRef = (0, import_react2.useRef)(0.5);
  const lineSmoothCloseRef = (0, import_react2.useRef)(0);
  const lineSmoothInitedRef = (0, import_react2.useRef)(false);
  const closeLineSmoothRef = (0, import_react2.useRef)(0);
  const closeLineSmoothInitedRef = (0, import_react2.useRef)(false);
  const lineModeProgRef = (0, import_react2.useRef)(0);
  const lineModeTransRef = (0, import_react2.useRef)({ startMs: 0, from: 0, to: 0 });
  const lineDensityProgRef = (0, import_react2.useRef)(0);
  const lineDensityTransRef = (0, import_react2.useRef)({ startMs: 0, from: 0, to: 0 });
  const lineTickSmoothRef = (0, import_react2.useRef)(0);
  const lineTickSmoothInitedRef = (0, import_react2.useRef)(false);
  const candleWidthTransRef = (0, import_react2.useRef)({
  ...
  const prevCandleDataRef = (0, import_react2.useRef)({ candles: [], width: config.candleWidth ?? 1 });
  const pausedCandlesRef = (0, import_react2.useRef)(null);
  const pausedLiveRef = (0, import_react2.useRef)(null);
  const pausedLineDataRef = (0, import_react2.useRef)(null);
  const pausedLineValueRef = (0, import_react2.useRef)(null);
  const lastCandlesRef = (0, import_react2.useRef)([]);
  const lastLiveRef = (0, import_react2.useRef)(null);
  const lastLineDataStashRef = (0, import_react2.useRef)([]);
  const lastLineValueStashRef = (0, import_react2.useRef)(void 0);
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const onLeave = () => {
      ...
      (_b = (_a = configRef.current).onHover) == null ? void 0 : _b.call(_a, null);
    };
  ...
  const draw = (0, import_react2.useCallback)(() => {
    ...
    if (isCandle) {
      if (cfg.paused && pausedCandlesRef.current === null && (((_a = cfg.candles) == null ? void 0 : _a.length) ?? 0) > 0) {
        pausedCandlesRef.current = cfg.candles.slice();
        pausedLiveRef.current = cfg.liveCandle ?? null;
        pausedLineDataRef.current = ((_b = cfg.lineData) == null ? void 0 : _b.slice()) ?? null;
    ...
    if (isCandle) {
      ...
      if (!isActiveHover && scrubAmount > 0 && lastHoverRef.current) {
        ...
        lastHoverRef.current = { x: hoverPx, value: (hoveredCandle == null ? void 0 : hoveredCandle.close) ?? 0, time: drawHoverTime };
      }
      ...
      if (effectiveLineData && effectiveLineData.length > 0 && (lineDensityProg > 0.01 || lineModeProg > 0.05)) {
        ...
        lineSmoothValue = lineSmoothInitedRef.current ? lineSmoothCloseRef.current : (drawLive == null ? void 0 : drawLive.close) ?? ((_c = drawCandles[drawCandles.length - 1]) == null ? void 0 : _c.close) ?? 0;
      }
      ...
      drawCandleFrame(ctx, layout, cfg.palette, {
        ...
        liveTime: (effectiveLive == null ? void 0 : effectiveLive.time) ?? -1,
        ...
        scrubAmount,
        hoverX: drawHoverX,
        hoverValue: (drawHoverCandle == null ? void 0 : drawHoverCandle.close) ?? null,
        hoverTime: drawHoverTime,
      ...
      for (const s of effectiveMultiSeries) {
        ...
        const target = (hiddenIds == null ? void 0 : hiddenIds.has(s.id)) ? 0 : 1;
        alpha = noMotion ? target : lerp(alpha, target, SERIES_TOGGLE_SPEED, pausedDt);
        if (alpha < 0.01) alpha = 0;
        if (alpha > 0.99) alpha = 1;
        seriesAlphas.set(s.id, alpha);
      }
      const firstData = ((_e = (_d = pausedMultiDataRef.current) == null ? void 0 : _d.get(firstSeries.id)) == null ? void 0 : _e.data) ?? firstSeries.data;
      ...
      if (transition.startMs > 0 && effectiveMultiSeries.length > 1) {
        ...
        for (const s of effectiveMultiSeries) {
          const sData = ((_g = (_f = pausedMultiDataRef.current) == null ? void 0 : _f.get(s.id)) == null ? void 0 : _g.data) ?? s.data;
          ...
          if (targetVisible.length > 0) {
            const range = computeRange(targetVisible, sv, (_h = cfg.referenceLine) == null ? void 0 : _h.value, cfg.exaggerate);
      ...
      for (const s of effectiveMultiSeries) {
        const snap = (_i = pausedMultiDataRef.current) == null ? void 0 : _i.get(s.id);
        const seriesData = (snap == null ? void 0 : snap.data) ?? s.data;
        const visible = [];
        ...
        if (visible.length >= 2) {
          if (alpha > 0.01) {
            const range = computeRange(visible, sv, (_j = cfg.referenceLine) == null ? void 0 : _j.value, cfg.exaggerate);
      ...
      const computedRange = cfg.yDomain ? { min: cfg.yDomain.min, max: cfg.yDomain.max } : { min: isFinite(globalMin) ? globalMin : 0, max: isFinite(globalMax) ? globalMax : 1 };
      ...
      if (hoverPx !== null && hoverPx >= pad.left && hoverPx <= w - pad.right) {
        ...
        lastHoverRef.current = { x: clampedX, value: ((_k = hoverEntries[0]) == null ? void 0 : _k.value) ?? 0, time: t };
        lastHoverEntriesRef.current = hoverEntries;
        (_n = cfg.onHover) == null ? void 0 : _n.call(cfg, { time: t, value: ((_l = hoverEntries[0]) == null ? void 0 : _l.value) ?? 0, x: clampedX, y: layout.toY(((_m = hoverEntries[0]) == null ? void 0 : _m.value) ?? 0) });
      }
      const scrubTarget = isActiveHover ? 1 : 0;
      if (noMotion) {
      ...
      const computedRange = computeRange(visible, smoothValue, (_o = cfg.referenceLine) == null ? void 0 : _o.value, cfg.exaggerate);
      const isWindowTransitioning = transition.startMs > 0;
      const rangeResult = updateRange(
        computedRange,
        rangeInitedRef.current,
      ...
      const valEl = (_p = cfg.valueDisplayRef) == null ? void 0 : _p.current;
      if (valEl) {
...
function Liveline({
  ...
  const valueDisplayRef = (0, import_react.useRef)(null);
  const windowBarRef = (0, import_react.useRef)(null);
  const windowBtnRefs = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  const [indicatorStyle, setIndicatorStyle] = (0, import_react.useState)(null);
  const modeBarRef = (0, import_react.useRef)(null);
  const modeBtnRefs = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  const [modeIndicatorStyle, setModeIndicatorStyle] = (0, import_react.useState)(null);
  const [hiddenSeries, setHiddenSeries] = (0, import_react.useState)(/* @__PURE__ */ new Set());
  const lastSeriesPropRef = (0, import_react.useRef)(seriesProp);
  ...
  const showSeriesToggle = (((_a = lastSeriesPropRef.current) == null ? void 0 : _a.length) ?? 0) > 1;
  const seriesPalettes = (0, import_react.useMemo)(() => {
    if (!seriesProp || seriesProp.length === 0) return null;
    return resolveSeriesPalettes(seriesProp, theme);
  }, [seriesProp, theme]);
  const multiSeries = (0, import_react.useMemo)(() => {
  ...
  const pad = {
    top: (paddingOverride == null ? void 0 : paddingOverride.top) ?? 12,
    right: (paddingOverride == null ? void 0 : paddingOverride.right) ?? defaultRight,
    bottom: (paddingOverride == null ? void 0 : paddingOverride.bottom) ?? 28,
    left: (paddingOverride == null ? void 0 : paddingOverride.left) ?? 12
  };
  ...
  const [activeWindowSecs, setActiveWindowSecs] = (0, import_react.useState)(
  ...
  const handleSeriesToggle = (0, import_react.useCallback)((id) => {
    setHiddenSeries((prev) => {
      const next = new Set(prev);
      if (next.has(id)) {
        next.delete(id);
        onSeriesToggle == null ? void 0 : onSeriesToggle(id, true);
      } else {
        const totalSeries = (seriesProp == null ? void 0 : seriesProp.length) ?? 0;
        const visibleCount = totalSeries - next.size;
        if (visibleCount <= 1) return prev;
        next.add(id);
        onSeriesToggle == null ? void 0 : onSeriesToggle(id, false);
      }
      return next;
    });
  }, [seriesProp == null ? void 0 : seriesProp.length, onSeriesToggle]);
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    showValue && (0, import_jsx_runtime.jsx)(
      "span",
      {
        ref: valueDisplayRef,
        style: {
    ...
    (windows && windows.length > 0 || onModeChange || showSeriesToggle) && (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6, marginLeft: pad.left }, children: [
      windows && windows.length > 0 && (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ref: windowBarRef,
          style: {
          ...
          children: [
            ws !== "text" && indicatorStyle && (0, import_jsx_runtime.jsx)("div", { style: {
              position: "absolute",
              top: ws === "rounded" ? 3 : 2,
              ...
              return (0, import_jsx_runtime.jsx)(
                "button",
                {
                  ...
                  onClick: () => {
                    ...
                    onWindowChange == null ? void 0 : onWindowChange(w.secs);
                  },
                  style: {
                    position: "relative",
                    zIndex: 1,
      ...
      onModeChange && (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ref: modeBarRef,
          style: {
          ...
          children: [
            ws !== "text" && modeIndicatorStyle && (0, import_jsx_runtime.jsx)("div", { style: {
              position: "absolute",
              top: ws === "rounded" ? 3 : 2,
            ...
            (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: (0, import_jsx_runtime.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: (0, import_jsx_runtime.jsx)(
                  "path",
                  {
            ...
            (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: (0, import_jsx_runtime.jsxs)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: [
                  (0, import_jsx_runtime.jsx)(
                    "line",
                    {
                      x1: "3.5",
      ...
      showSeriesToggle && showSeriesChips && (0, import_jsx_runtime.jsx)("div", { style: {
        display: "inline-flex",
        gap: ws === "text" ? 4 : 2,
        background: ws === "text" ? "transparent" : isDark ? "rgba(255,255,255,0.03)" : "rgba(0,0,0,0.02)",
        borderRadius: ws === "rounded" ? 999 : 6,
...
function LivelineTransition({
  ...
  return (0, import_jsx_runtime2.jsx)("div", { className, style: { position: "relative", width: "100%", height: "100%", ...style }, children: childArray.map((child) => {
...
//# sourceMappingURL=liveline.js.map
